...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録がうまくいかないとき' do
      ...
      it "first_nameとfamily_nameに半角が使われている時登録できない" do
      ...
      it "first_name_kanaとfamily_name_kanaに半角が使われている時登録できない" do
      ...
      it "first_name_kanaとfamily_name_kanaがカタカナでない時登録できない" do
